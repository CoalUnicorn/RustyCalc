...
//! The trait is sealed — downstream crates cannot add backends.
//!
...
pub(crate) trait Painter: TextMetrics + private::Sealed {
...
pub(crate) trait BlitPainter: Painter {
