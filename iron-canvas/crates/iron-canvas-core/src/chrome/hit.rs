//! Pointer-resolution outcomes: what the cursor is over at a canvas point.
//!
//! [`HitTest`] is the result of `Chrome::hit_test`; [`RefZone`] and
//! [`ResizeTarget`] classify the finer sub-region the host acts on.
