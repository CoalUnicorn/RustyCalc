...
pub use axis::{AxisSlot, ColSlot, RowSlot};
pub use extent::{ExtentFetch, col_width, row_height};
pub use fill::{fill_axis, scroll_first};

use self::fill::{boundary_at, last_visible_id, pixel_to_id, slot_at, top_id};
