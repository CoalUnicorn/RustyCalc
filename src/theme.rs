...
pub use iron_canvas::theme::{CanvasTheme, DARK, LIGHT};
...
// CanvasTheme, LIGHT, DARK, FORMULA_REF_COLORS are now re-exported from `crate::canvas::theme`
// at the top of this file. Canvas is the source of truth for paint-related types.
