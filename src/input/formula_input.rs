...
mod tests {
    ...
    fn at_a1() -> RefNode {
        RefNode::cell(1, None, 0, 0, Absolute { row: false, column: false })
    }

    /// 1x1 range at B3 — row delta 2, column delta 1 from editing=A1.
    fn at_b3() -> RefNode {
        RefNode::cell(1, None, 2, 1, Absolute { row: false, column: false })
    }
    ...
    fn point_move_bare_equals_arrow_down_enters_a2() {
        ...
        assert_eq!(
            ...
            PointMoveOutcome::Move(PointingStep {
                text: "=A2".to_string(),
                ref_node: RefNode::cell(1, None, 1, 0, Absolute { row: false, column: false }),
    ...
    fn point_move_shift_extends_anchor() {
        ...
        assert_eq!(
            ...
            PointMoveOutcome::Move(PointingStep {
                ...
                ref_node: RefNode::range(1, None, 2, 1, Absolute { row: false, column: false }, 3, 1, Absolute { row: false, column: false }),
    ...
    fn point_move_plain_arrow_moves_whole_range() {
        ...
        assert_eq!(
            ...
            PointMoveOutcome::Move(PointingStep {
                text: "=C3".to_string(),
                ref_node: RefNode::cell(1, None, 2, 2, Absolute { row: false, column: false }),
                span: TextRef { start: 1, end: 3 },
            }),
        );
    }
    ...
    fn caret_on_absolute_ref_preserves_dollars() {
        ...
        let ctx = PointMoveCtx {
            ...
            cursor: 3,
            already_pointing: false,
            current_ref: RefNode::cell(1, None, 1, 1, Absolute { row: true, column: true }),
        ...
        assert_eq!(
            ...
            PointMoveOutcome::Move(PointingStep {
                text: "=$A$2".to_string(),
                ref_node: RefNode::cell(1, None, 2, 1, Absolute { row: true, column: true }),
    ...
    fn caret_on_cross_sheet_ref_preserves_sheet() {
        ...
        let ctx = PointMoveCtx {
            ...
            cursor: 9,
            already_pointing: false,
            current_ref: RefNode::cell(2, Some("Sheet2".to_string()), 1, 1, Absolute { row: false, column: false }),
        ...
        assert_eq!(
            ...
            PointMoveOutcome::Move(PointingStep {
                ...
                ref_node: RefNode::cell(2, Some("Sheet2".to_string()), 1, 2, Absolute { row: false, column: false }),
    ...
    fn caret_on_relative_ref_stays_relative() {
        ...
        let ctx = PointMoveCtx {
            ...
            cursor: 2,
            already_pointing: false,
            current_ref: RefNode::cell(1, None, 0, 0, Absolute { row: false, column: false }),
    ...
    fn drag_body_rewrites_formula_text() {
        ...
        let original = RefNode::cell(0, None, 0, 0, Absolute { row: false, column: false });
    ...
    fn drag_corner_resizes_range_in_text() {
        ...
        let original = RefNode::range(0, None, 0, 0, Absolute { row: false, column: false }, 1, 1, Absolute { row: false, column: false });
    ...
    fn drag_preserves_absolute_flags_both_axes() {
        ...
        let original = RefNode::cell(0, None, 1, 1, Absolute { row: true, column: true });
    ...
    fn drag_preserves_mixed_absolute_flags() {
        ...
        let original = RefNode::cell(0, None, 0, 1, Absolute { row: false, column: true });
        let new = SheetRange::from_cell(0, 3, 2);
    ...
    fn drag_preserves_cross_sheet_prefix() {
        ...
        let original = RefNode::cell(1, Some("Sheet2".into()), 0, 0, Absolute { row: false, column: false });
